...
void add_loop_closing_edges(const vector<Pose>& poses, vector<Edge>& edges){
	...
	add_loop_closing_edge(poses[0], poses[last], edges);
	add_loop_closing_edge(poses[2], poses[last], edges);
	add_loop_closing_edge(poses[5], poses[last-2], edges);
	add_loop_closing_edge(poses[5], poses[last-4], edges);
	add_loop_closing_edge(poses[7], poses[last-4], edges);
}
